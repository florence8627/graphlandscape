    ...
    .call(d3.behavior.drag()
      ...
      .on("dragend", function(d) {
        ...
        if (orderChanged) {
          ...
          console.log(__.dimensionTitles);
...
pc.updateFrntView =   function(ids) {

  z = __.data[0].length-1;  // last element index
...
(function() {
  ...
  function onDragEnd() {
    return function() {
      ...
      // Trigger event from Canvas containing selected strum ids

      var ids = brushed.map( function( strum ) {
